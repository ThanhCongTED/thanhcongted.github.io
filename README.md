...
Tích hợp Tensorflow Lite (TFlite) - bao gồm trình bao bọc dễ sử dụng
Xử lý hình ảnh nội tuyến (phát hiện đặc điểm, căn chỉnh, trích xuất ROI)
Thiết bị nhỏ gọn và giá rẻ (3x4,5x2 cm³, < 10 EUR)
Tích hợp camera và đèn chiếu sáng
Giao diện web để quản trị và điều khiển
Giao diện OTA để cập nhật trực tiếp thông qua giao diện web
Tích hợp đầy đủ vào Home Assistant
Hỗ trợ Influx DB 1 và 2
MQTT
API REST
1.2 Idea
Idea
...
Edit Reference
Hãy tận hưởng niềm vui khi nghiên cứu những khả năng và ý tưởng mới.
